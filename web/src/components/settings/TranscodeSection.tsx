      ...
      {status && (
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-fg-muted">Acceleration</span>
            <span className="font-medium">
              {status.gpu_available ? (
                ...
                <span className="text-fg-muted">CPU Only</span>
              )}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-fg-muted">Encoder</span>
          ...
          <div className="flex justify-between">
            <span className="text-fg-muted">GPU Enabled</span>
            <span>{status.gpu_enabled ? "Yes" : "No"}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-fg-muted">CPU Fallback</span>
