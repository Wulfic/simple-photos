...
CREATE INDEX IF NOT EXISTS idx_shared_albums_owner ON shared_albums(owner_user_id);
...
CREATE INDEX IF NOT EXISTS idx_shared_album_members_user  ON shared_album_members(user_id);
CREATE INDEX IF NOT EXISTS idx_shared_album_members_album ON shared_album_members(album_id);
